...
-   You choose to either design first in OAS or use tools for your language to
    generate dynamic swagger at build or runtime.
...
-   You should use masking tape to hold a windowpane in place before applying
    glazing compounds.
